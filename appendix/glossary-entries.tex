...
\newglossaryentry{knn-g}{
    ...
    text=KNN,
    sort=knn,
    description={La tecnica \emph{KNN, K-Nearest Neighbors} è una tecnica utilizzata per la classificazione e la regressione che si basa sul concetto di vicinanza tra i dati. Viene etichettato un nuovo punto all'interno dello spazio vettoriale, in base all'etichetta dei K punti più vicini ad esso. Viene comunemente usata in ambito di \textit{machine learning} e sistemi di raccomandazione}
}
