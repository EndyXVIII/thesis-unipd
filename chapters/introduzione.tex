...
Ogni progetto viene svolto in tutte le sue parti dal \textit{team} di Zero12, dalla progettazione fino al suo sviluppo. L’azienda è parte di Var Group S.p.A., l'operatore \textit{leader} nel settore dei servizi e delle soluzioni digitali. Supporta le imprese nel loro percorso di trasformazione digitale, offrendo ai propri \textit{partner} servizi e competenze per lo sviluppo di soluzioni innovative.
