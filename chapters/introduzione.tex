...
Ogni progetto viene svolto in tutte le sue parti dal \textit{team} di Zero12, dalla progettazione fino al suo sviluppo. L’azienda è parte di Var Group S.p.A., un \textit{leader} italiano nell’innovazione tecnologica, che supporta i propri \textit{partner} fornendo servizi e competenze necessarie per raggiungere gli obiettivi prefissati.
...
\end{figure}
\noindent
Nella figura \ref{fig:scrum} illustro il flusso di lavoro di un progetto con metodologia \textit{Scrum} adottato da Zero12. Ogni nuovo progetto segue questo flusso. 
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.66\textwidth]{Jira.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.64\textwidth]{github.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{sviluppoIntegrazione.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{sqlvsnosql.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{serverless.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.73\textwidth]{streamlit.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.73\textwidth]{eslint.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.73\textwidth]{postman.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{tecnologie.png}
