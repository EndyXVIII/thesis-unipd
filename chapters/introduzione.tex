...
Come esempio di queste soluzioni, l'azienda ha sviluppato applicazioni \textit{web} e \textit{mobile} per la gestione di dati e servizi a clienti operanti nel settore della moda. Ha inoltre sviluppato applicazioni interamente basate sui servizi offerti da \gls{aws}, a clienti operanti nello stesso settore dell'azienda.
