...
Un' esempio concreto dell'operato di Zero12 è lo sviluppo di applicazioni \textit{web} e \textit{mobile} per la gestione di dati e servizi a clienti operanti nel settore della moda. Ha inoltre sviluppato applicazioni interamente basate sui servizi offerti da \gls{aws}, a clienti operanti nello stesso settore dell'azienda.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\textwidth]{scrum.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.84\textwidth]{sviluppoIntegrazione.png}
