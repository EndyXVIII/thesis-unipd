...
Langchain è un \textit{framework open-source} che fornisce strumenti e componenti modulari per la creazione di applicazioni, come \textit{chatbot}, che struttano i \gls{llm}. Questo \textit{framework} permette un interazione più semplice con questi modelli, permettendo di creare applicazioni che sfruttano le potenzialità dei \gls{llm} in modo più semplice. Nel contesto dello \textit{stage}, viene utilizzato assieme al \textit{framework} Streamlit.
\begin{figure}[H]
    \centering
