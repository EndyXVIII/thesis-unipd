...
È possibile suddividere il progetto in \textit{branch}, rami di sviluppi separati da quello principale, assegnati a specifiche \textit{feature} da sviluppare, permettendo cosi di lavorare in modo parallelo.
