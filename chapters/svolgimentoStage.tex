...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{architetturaBenchmark.png}
...
if input_text:
    ...
    \end{minted}
    \captionof{figure}{Frammento del codice Python relativo al frontend}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.67\textwidth]{eventTest.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.83\textwidth]{create_Issue.png}
