...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{benchmark.png}
...
\begin{lstlisting}[caption=Configurazione delle funzioni \textit{lambda} del sistema Jira in \textit{index.ts}, label=lst:handlersJira]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{dto.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{factoryPattern.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{strategy.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{architettura.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{chatbot_architettura.png}
...
\begin{itemize}
    ...
    \begin{minted}[linenos,numbersep=5pt,frame=lines,framesep=2mm]{typescript}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{eventTest.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{create_Issue.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{generatingResponse.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{responseGenerated.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{noResponse.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{closed.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{beforeSignIn.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{afterSignIn.png}
