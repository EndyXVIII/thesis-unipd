...
\usepackage{ragged2e}                   % Per giustificare il testo
\usepackage{xcolor, colortbl}           % Per aggiungere colori alla tabella
\usepackage{float}                      % Per posizionare le immagini

\usepackage{fancyvrb}                   % Per aggiungere codice
\usepackage{minted}                     % Per aggiungere codice
